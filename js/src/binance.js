...
import { AccountSuspended, ArgumentsRequired, AuthenticationError, BadRequest, BadResponse, BadSymbol, DDoSProtection, ExchangeError, InsufficientFunds, InvalidNonce, InvalidOrder, MarginModeAlreadySet, MarketClosed, NetworkError, NotSupported, OnMaintenance, OperationFailed, OperationRejected, OrderImmediatelyFillable, OrderNotFillable, OrderNotFound, PermissionDenied, RateLimitExceeded, RequestTimeout, } from './base/errors.js';
...
export default class binance extends Exchange {
    describe() {
        return this.deepExtend(super.describe(), {
            ...
            'countries': [],
            'currencies': {
                'BNFCR': this.safeCurrencyStructure({
                    'code': 'BNFCR',
                    'id': 'BNFCR',
