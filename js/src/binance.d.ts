...
import type { Balances, Conversion, CrossBorrowRate, Currencies, Currency, Dict, FundingRateHistory, Greeks, Int, IsolatedBorrowRate, IsolatedBorrowRates, Leverage, Leverages, Liquidation, MarginMode, MarginModes, MarginModification, Market, MarketInterface, Num, OHLCV, OpenInterest, Option, Order, OrderBook, OrderRequest, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, TradingFees, Transaction, TransferEntries, TransferEntry } from './base/types.js';
/**
 * @class binance
 * @augments Exchange
 */
