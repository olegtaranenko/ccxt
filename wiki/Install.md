...
* jsDelivr: https://cdn.jsdelivr.net/npm/ccxt@3.1.7-ot.2-ot.0/dist/ccxt.browser.js
* unpkg: https://unpkg.com/ccxt@3.1.7-ot.2-ot.0/dist/ccxt.browser.js
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/ccxt@3.1.7-ot.2-ot.0/dist/ccxt.browser.js"></script>
```
