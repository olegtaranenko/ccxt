...
func (this *BinanceusdmCore) SapiGetLoanFlexibleCollateralData (args ...interface{}) <-chan interface{} {
   return this.callEndpointAsync("sapiGetLoanFlexibleCollateralData", args...)
}

func (this *BinanceusdmCore) SapiGetLoanFlexibleLoanableData (args ...interface{}) <-chan interface{} {
...
func (this *BinanceusdmCore) SapiPostLoanFlexibleBorrow (args ...interface{}) <-chan interface{} {
