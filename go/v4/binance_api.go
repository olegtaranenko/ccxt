...
func (this *BinanceCore) SapiGetLoanFlexibleCollateralData (args ...interface{}) <-chan interface{} {
   return this.callEndpointAsync("sapiGetLoanFlexibleCollateralData", args...)
}

func (this *BinanceCore) SapiGetLoanFlexibleLoanableData (args ...interface{}) <-chan interface{} {
...
func (this *BinanceCore) SapiPostLoanFlexibleBorrow (args ...interface{}) <-chan interface{} {
